...
void WriteR5BSPFile(const char *filename) {
    ...
    AddLump(file, header.lumps[R5_LUMP_PORTALS],                         Titanfall::Bsp::portals_stub);
    AddLump(file, header.lumps[R5_LUMP_PORTAL_VERTICES],                 Titanfall::Bsp::portalVertices_stub);
    AddLump(file, header.lumps[R5_LUMP_PORTAL_EDGES],                    Titanfall::Bsp::portalEdges_stub);
    AddLump(file, header.lumps[R5_LUMP_PORTAL_VERTEX_EDGES],             Titanfall::Bsp::portalVertexEdges_stub);
    AddLump(file, header.lumps[R5_LUMP_PORTAL_VERTEX_REFERENCES],        Titanfall::Bsp::portalVertexReferences_stub);
    AddLump(file, header.lumps[R5_LUMP_PORTAL_EDGE_REFERENCES],          Titanfall::Bsp::portalEdgeReferences_stub);
    AddLump(file, header.lumps[R5_LUMP_PORTAL_EDGE_INTERSECT_EDGE],      Titanfall::Bsp::portalEdgeIntersectEdge_stub);
    AddLump(file, header.lumps[R5_LUMP_PORTAL_EDGE_INTERSECT_AT_VERTEX], Titanfall::Bsp::portalEdgeIntersectAtVertex_stub);
    AddLump(file, header.lumps[R5_LUMP_PORTAL_EDGE_INTERSECT_HEADER],    Titanfall::Bsp::portalEdgeIntersectHeader_stub);
