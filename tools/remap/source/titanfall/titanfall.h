...
namespace Titanfall {
    ...
    namespace Bsp {
        ...
        inline std::vector<uint8_t>  portalEdgeIntersectEdge_stub;
        inline std::vector<uint8_t>  portalEdgeIntersectAtVertex_stub;
        inline std::vector<uint8_t>  portalEdgeIntersectHeader_stub;
    }
}
